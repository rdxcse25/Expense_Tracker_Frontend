...
const Income = () => {
  ...
  return (
    <div className='px-4 my-12'>
      ...
      <h2 className='mb-8 text-3xl font-bold'>Upload Income</h2>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col flex-wrap gap-4 lg:w-[1180px]'>
        ...
        <div className='flex flex-col gap-8 md:flex-row'>
          ...
          <div className='md:w-1/2'>
            <div className='mb-2 block'>
              <Label htmlFor='title' value='Income Source' />
            </div>
            <TextInput id='title' name='title' type='text' placeholder='Income Source' required />
          </div>
        ...
        <div className='flex flex-col gap-8 md:flex-row'>
          ...
          <div className='md:w-1/2'>
            <div className='mb-2 block'>
              <Label htmlFor='categoryName' value='Income Category' />
            </div>
            <select
              id='categoryName'
              name='categoryName'
